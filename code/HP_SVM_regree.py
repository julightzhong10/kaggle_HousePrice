...
def main():
	...
	clf = svm.SVR(kernel=kernel, degree=5, gamma='auto', coef0=0.0, tol=0.001, C=50.0, epsilon=0.1, shrinking=True, cache_size=200)
	...
	print(kernel+':',math.sqrt(validation_accu(val_x,ValSet[1])))
	data_Id=TestSet[1]
	# print(TestSet[0])
